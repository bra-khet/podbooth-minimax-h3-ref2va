...
- [x] Parent Gradio `h3_ref2va_gui.py` + `run-ref2va.ps1` on **7865**. Kitchen default **off**. Full 9/3/3/12 UI. Tina six-section placeholders live in the parent GUI only.
